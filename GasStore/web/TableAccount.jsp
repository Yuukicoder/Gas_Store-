...
<html lang="en">
    ...
    <body>
                    ...
                    <div class="bg-secondary text-center rounded p-4">
                        ...
                        <div class="container-fluid pt-4 px-4">
                                        ...
                                        <tbody>
                                            <c:forEach items="${requestScope.lidata}" var="o">
                                                <tr>
                                                    ...
                                                    <td><a href="ManageUser?type=0&id=${o.getCustomerID()}">Update</a><br><a href="ManageUser?type=1&id=${o.getCustomerID()}">Delete</a></td>
                                                </tr>
                                            </c:forEach>
                                        </tbody>
                                    </table>
                            ...
                            <div class="container mt-4">
                                <a href="ManagerAccount.jsp" class="btn btn-primary">Back to Manager Account</a>
                            </div>
                            <div class="container mt-4">
                                <!-- Anchor to toggle the visibility of the insert div -->
        ...
        <script>
            ...
            // Get a reference to the insert div
            ...
            toggleInsertAnchor.addEventListener('click', function (event) {
                event.preventDefault(); // Prevent default anchor behavior (e.g., navigating to a different page)

                // Toggle the visibility of the insert div
        ...
        <style>
            ...
            #productTable td {
                color: #111; /* Darker text color for table data */
            }

            #productTable tr:nth-child(even) td {
                color: #000; /* Slightly darker text color for even rows */
            }

            #productTable tr:hover td {
                color: #000; /* Darker text color on hover for better highlighting */
            }
        </style>

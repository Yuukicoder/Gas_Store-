    ...
    <div class="container" id="container">
        <div class="form-container sign-up">
            <form action="signup" method="POST">
                ...
                <input type="text" id="username-input1" class="form-control" placeholder="Username" required autofocus="" name="username1">
                <input type="password" id="password-field1" class="form-control" placeholder="Password" required autofocus="" name="password1">

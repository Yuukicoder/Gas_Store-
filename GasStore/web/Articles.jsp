<%-- 
    Document   : Articles
    Created on : May 12, 2024, 4:49:48 PM
    Author     : Admin
--%>
        ...
        <div class="container">
            <div class="wrapper d-flex">
                ...
                <div id="content" class="p-4 p-md-5 pt-5">
                                ...
                                <div class="row no-gutters">
                                    <div class="col-md-4">       
                                        <a href="#" class="image-hvr-effect">
                                            <img src="http://bepgashathanh.vn/imgs/Van-Gas-An-Toan-Nhat-Ban-12.jpg"
                                                 class="post-image"
                                                 alt="">
                                        </a>                                 
                                    </div>
                                    <div class="col-md-8">
                                        <div class="card-body">
                                            <h3 style="font-weight: bold; --heading-font: initial" >Nguyên nhân hở van gas & lưu ý cần nhớ</h3>
                                            <p>Một trong những nguyên nhân gây cháy nổ rất nguy hiểm hiện nay đó là rò rỉ 
                                                gas. Gas bị rò rỉ có thể do van gas, bình gas, dây gas hoặc bếp gas. 
                                                Trong bài viết này, chúng tôi sẽ chia sẻ với các bạn nguyên nhân rò rỉ 
                                                gas do van gas và một số lưu ý để tránh rò rỉ gas hiệu quả.</p>
                                            <a href="ArticleDetail.jsp"
                                               class="btn btn-outline-accent">View</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="card flex-row flex-wrap">
                            <div class="card mb-3" style="">
                                <div class="row no-gutters">
                                    <div class="col-md-4">
                                        <a href="#" class="image-hvr-effect">
                                            <img src="http://bepgashathanh.vn/imgs/su-dung-bep-gas-don-18.jpg" class="post-image"
                                                 alt="">
                                        </a>
                                    ...
                                    <div class="col-md-8">
                                        <div class="card-body">
                                            <h3 style="font-weight: bold; --heading-font: initial" >Bếp gas đơn nào vừa có giá tốt vừa chất lượng phù hợp với sinh viên</h3>
                                                <p>Sinh viên khi sống xa nhà, mới đầu sẽ phải sắm sửa rất 
                                                    nhiều, thiết bị nhà bếp được các bạn ưu tiên chọn mua đầu tiên đó là bếp 
                                                    gas đơn. Vì sản phẩm này có giá thành tương đối rẻ và phù hợp với khả năng
                                                    tài chính và nhu cầu sử dụng ít người. Không những thế, với những không 
                                                    gian phòng trọ chật hẹp và nhiều bạn thường xuyên thay đổi chỗ</p>
                                                <a href="ArticleDetail.jsp"
                                                   class="btn btn-outline-accent">View</a>
                                        </div>
                                    </div>
                        ...
                        <div class="card flex-row flex-wrap">
                            <div class="card mb-3" style="">
                                <div class="row no-gutters">
                                    ...
                                    <div class="col-md-8">
                                        <div class="card-body">
                                            <h3 style="font-weight: bold; --heading-font: initial" >4 nguyên tắc sử dụng cơ bản giúp bếp gas âm luôn bền mới</h3>
                                            <p>Dù xuất hiện sau bếp gas dương nhưng sản phẩm bếp gas âm đã không mất quá 
                                                nhiều thời gian để khẳng định chất lượng và vị thế của mình trong lòng của 
                                                người tiêu dùng. Các sản phẩm bếp gas âm đã nhanh chóng xâm nhập vào các 
                                                gian bếp và trở thành người bạn thân thiết, không thể thiếu của các bà nội trợ.</p>
                                            <a href="ArticleDetail.jsp"
                                               class="btn btn-outline-accent">View</a>
                                        </div>
                                    </div>
                    ...
                    <div align="center">
                        <a class="btn btn-outline-accent" href="">1</a>
                        <a class="btn btn-outline-accent" href="">2</a>
                        <a class="btn btn-outline-accent" href="">3</a>
                    </div>
                </div>
            </div>
        </div>

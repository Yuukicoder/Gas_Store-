                                ...
                                <c:if test="${size > 0}">
                                    <div class="table-responsive">
                                        <table id="productTable" class="table text-start align-middle table-bordered table-hover mb-0">
                                            <thead>
                                                <tr class="text-white" >
                                                    <th scope="col"style="background: #0077b6;"></th>
                                                    <th scope="col"style="background: #0077b6;">Name</th>
                                                    <th scope="col"style="background: #0077b6;">Category</th>
                                                    <th scope="col"style="background: #0077b6;">Quantity</th>
                                                    <th scope="col"style="background: #0077b6;">Price</th>

                        ...
                        <div class="row g-4">
                            ...
                            <div class="bg-secondary text-center rounded p-4">
                                ...
                                <div class="d-flex align-items-center justify-content-between mb-4">
                                    ...
                                    <form action="staffProductManage?action=show" method="post">
...
<!--                                    <a href="productAdd" class="btn btn-primary">Add new product</a>
                                    ...
                                    <nav style="float: right;margin-top: 25px; color: black" aria-label="Page navigation example">
                                        <ul class="pagination">
                                            <c:if test="${tag > 1}">
                                                <li  class="page-item"><a style="color: black"  class="page-link" href="staffProductManage?indexPage=${tag-1}&amp;action=${action}"">Previous</a></li>
                                                </c:if>
                                                <c:forEach begin="1" end="${endPage}" var="i">
                                                <li style="color: black"  class="page-item ${tag == i ?"active":"" || page1 == i ?"active":""  } "><a style="color: black"  class="page-link" href="staffProductManage?indexPage=${i}&amp;action=${action}">${i}</a></li>
                                                </c:forEach>
                                                <c:if test="${tag<endPage}">
                                                <li class="page-item"><a style="color: black"  class="page-link" href="staffProductManage?indexPage=${tag+1}&amp;action=${action}">Next</a></li>
                                                </c:if>
                                        </ul>
                                    </nav>

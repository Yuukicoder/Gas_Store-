                ...
                <div class="col-md-12">
                    <div class="well">
                        ...
                        <div style="display: inline-block; vertical-align: top; width: 20%; margin: 20px;">
                            <ul class="list-group">
                                <h5> Address</h5>
                                <h6 class="mt-1 mb-2"><i class='bx bx-user'></i> ${sessionScope.account.getUserName()}</h6>
                                <p class="mb-1 mt-1" style="color: grey;"><i class='bx bx-phone'></i> ${sessionScope.account.getPhone()}</p>
                                <p class="mt-1" style="color: grey;"><i class='bx bx-user'></i> ${sessionScope.account.getAddress()}</p>
                            </ul>
                        </div>

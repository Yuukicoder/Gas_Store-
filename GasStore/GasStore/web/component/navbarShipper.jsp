                    ...
                    <div class="dropdown-menu dropdown-menu-end bg-secondary border-0 rounded-0 rounded-bottom m-0">
                        ...
                        <c:if test="${sessionScope.notiList.size() > 0}">
                            <c:forEach var="noti" items="${sessionScope.notiList}">
                                <a href="ShipperNotificationDetail?id=${noti.getNotiID()}" class="dropdown-item">
                        ...
                        <a href="ShipperAllNotification" class="dropdown-item text-center">See all notifications</a>
                    </div>
                </div>
                <div class="nav-item dropdown">
                    <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
                        <img class="rounded-circle me-lg-2" src="images/User/${sessionScope.account.getImage()}" alt="" style="width: 40px; height: 40px;">
                        <span class="d-none d-lg-inline-flex">${sessionScope.account.getFullname()}</span>
                    </a>
                    <div class="dropdown-menu dropdown-menu-end bg-secondary border-0 rounded-0 rounded-bottom m-0">
                        <a href="ShipperProfile" class="dropdown-item">My Profile</a>

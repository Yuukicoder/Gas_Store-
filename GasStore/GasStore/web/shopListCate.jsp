                            ...
                            <div class="col-12">
                                <nav>
                                    <ul class="pagination justify-content-center">
                                        <li class="page-item <c:if test="${requestScope.currentPageLS == 1}">disabled</c:if>"><a class="page-link" href="filterProduct?${requestScope.paginationQueryParams}&pageLS=${requestScope.currentPageLS - 1}">Previous</a></li>
                                            <c:forEach var="i" begin="1" end="${requestScope.maxPageLS}">
                                            <li class="page-item <c:if test="${i == requestScope.currentPageLS}">active</c:if>"><a class="page-link" href="filterProduct?${requestScope.paginationQueryParams}&pageLS=${i}">${i}</a></li>
                                            </c:forEach>
                                        <li class="page-item <c:if test="${requestScope.currentPageLS == requestScope.maxPageLS}">disabled</c:if>"><a class="page-link" href="filterProduct?${requestScope.paginationQueryParams}&pageLS=${requestScope.currentPageLS + 1}">Next</a></li>
                                        </ul>
                                    </nav>
                                </div>
                            </div>

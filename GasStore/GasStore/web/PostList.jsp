...
<body>
    ...
    <div id="wrapper">
        <form action="PostListController">
            <div class="option">
                <a href="PostListController?num=0">Newest</a>
                    ...
                    <nav>
                        <ul class="pagination justify-content-center">
                            <li class="page-item <c:if test="${requestScope.currentPage == 1}">disabled</c:if>">
                                <a class="page-link" href="PostListController?page=${requestScope.currentPage - 1}">Previous</a>
                            </li>
                            <c:forEach var="i" begin="1" end="${requestScope.maxPage}">
                                <li class="page-item <c:if test="${i == requestScope.currentPage}">active</c:if>">
                                    <a class="page-link" href="PostListController?page=${i}">${i}</a>
                                </li>
                            </c:forEach>
                            <li class="page-item <c:if test="${requestScope.currentPage == requestScope.maxPage}">disabled</c:if>">
                                <a class="page-link" href="PostListController?page=${requestScope.currentPage + 1}">Next</a>
                            </li>
                        </ul>
                    </nav>
                </div>

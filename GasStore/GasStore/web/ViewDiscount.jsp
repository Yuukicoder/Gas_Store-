                    ...
                    <div class="blog-container">
                        <c:forEach items="${requestScope.paginatedPosts}" var="c">
                            <div class="blog-box">
                                ...
                                <div class="blog-text">
                                    <p>Discount Code: ${c.discountCode}</p>
                                    <!--<p>Discount Amount: ${c.discountAmount}%</p>-->
                                    <c:if test="${c.discountType eq 'PERCENT'}">
                                        <p>Discount Amount: ${c.discountAmount}%</p>      
                                    </c:if>
                                    <c:if test="${c.discountType eq 'FIXED'}">
                                        <p>Discount Amount: <fmt:formatNumber value="${c.discountAmount}" type="currency" currencySymbol="" maxFractionDigits="0"/>VND</p>
                                    </c:if>

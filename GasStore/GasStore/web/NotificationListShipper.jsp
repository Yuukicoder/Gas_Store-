<%-- 
    Document   : NotificationListShipper
    Created on : 10 Jul 2024, 21:15:34
    Author     : Vu Anh
--%>
...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8">
        <title>DarkPan - Bootstrap 5 Shipper Template</title>
                                        ...
                                        <tbody>
                                            <c:forEach var="n" items="${list}">
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a class="btn btn-sm btn-primary" href="ShipperNotificationDetail?id=${n.getNotiID()}">Detail</a>
                                                    </td>
                                                </tr>
                                            </c:forEach>
                                        </tbody>

<%-- 
    ...
    Created on : Jul 5, 2024, 3:35:02 PM
    Author     : Vu anh
--%>
            ...
            <div class="content">
                ...
                <div class="container-fluid pt-4 px-4">
                    ...
                    <div class="container rounded bg-white mt-3 mb-5">
                        <form action="ShipperProfile" method="post" id="formUpdate" enctype="multipart/form-data">
                            <div class="row">
                                <div class="col-md-3 col-lg-4 col-6 col-sm-12 border-right">

                                    <input type="text" name="imgString" value="${sessionScope.account.getImage()}" hidden>

                                    <div class="d-flex flex-column align-items-center text-center p-3 py-5 position-relative">                                        
                                        <img id="profileImage" class="mt-5 rounded-circle" width="50%;" src="images/User/${sessionScope.account.getImage()}" alt=" "/>
                                    ...
                                    <div class="p-3 py-5">
                                        ...
                                        <div class="row mt-3">
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <input type="text" class="form-control" value="${sessionScope.account.getFullname()}" name="shipperName" id="shipperName">
                                            </div>
                                            <div class="col-md-12">
                                                <label class="labels">Gender</label>
                                                <div>
                                                    <input type="radio" class="form-check-input" name="gender" id="gender" value="1" 
                                                            <c:if test="${sessionScope.account.getGender() == 1}">checked</c:if>>
                                                    <label class="form-check-label" for="male">Male</label>
                                                    <input type="radio" class="form-check-input" name="gender" id="gender" value="0" 
                                                            <c:if test="${sessionScope.account.getGender() == 0}">checked</c:if>>
                                                    <label class="form-check-label" for="female">Female</label>
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                                <label class="labels">Address</label>
                                                <input type="text" class="form-control" value="${sessionScope.account.getAddress()}" name="address" id="address" required>
                                            </div>
                                            <div class="col-md-12">
                                                <label class="labels">Phone</label>
                                                <input type="text" class="form-control" value="${sessionScope.account.getPhoneNumber()}" name="phone" id="phone" required>
                                            </div>
                                            <div class="col-md-12">

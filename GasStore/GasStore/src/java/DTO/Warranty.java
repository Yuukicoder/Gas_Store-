...
public class Warranty {
    ...
    public String toString() {
        return "Warranty{" + "WarrantyID=" + WarrantyID + ", SerialID=" + SerialID + ", supplierID=" + supplierID + ", customerID=" + customerID + ", Process_By=" + Process_By + ", WarrantyStartDate=" + WarrantyStartDate + ", WarrantyEndDate=" + WarrantyEndDate + ", WarrantyTerms=" + WarrantyTerms + ", ProofImg=" + ProofImg + ", BarCode=" + BarCode + ", Notes=" + Notes + ", Status=" + Status + ", SerialNumbers=" + SerialNumbers + ", CreateDate=" + CreateDate + ", ReciverDate=" + ReciverDate + ", expectedDate=" + expectedDate + ", DoneDate=" + DoneDate + '}';
    }
}

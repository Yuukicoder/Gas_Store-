...
public class FBConstants {
    public static String FACEBOOK_CLIENT_ID = "898071928705250";

	public static String FACEBOOK_CLIENT_SECRET = "b3d9cda3385cccc94e7741132a26bbab";
...
//	public static String FACEBOOK_GRANT_TYPE = "authorization_code";
}

...
public class NotificationDAO extends DBcontext{
    ...
    public ArrayList<NotificationDTO> getAllNotification() {
        ...
        try {
            ...
            System.out.println("NotificationDAO - getAllNotification: " + e.getMessage());
        }
        return list;
    }
    ...
    public NotificationDTO getNotificationById(int id) {
        ...
        try {
            ...
            System.out.println("NotificationDAO - getNotificationById: " + e.getMessage());
        }
        return null;
    }
    ...
    public ArrayList<NotificationDTO> getAllAdminNotification() {
        ...
        try {
            ...
            System.out.println("NotificationDAO - getAllAdminNotification: " + e.getMessage());
        }
        return list;
    }
    ...
    public ArrayList<NotificationDTO> getAllOtherTypeNotification(int receiverType, int uID) {
        ...
        try {
            ...
            System.out.println("NotificationDAO - getAllOtherTypeNotification: " + e.getMessage());
        }
        return list;
    }
    ...
    public ArrayList<NotificationDTO> getAdmin3NewestUnreadNoti() {
        ...
        try {
            ...
            System.out.println("NotificationDAO - getAdmin3NewestUnreadNoti: " + e.getMessage());
        }
        return list;
    }
    ...
    public ArrayList<NotificationDTO> getOther3NewestUnreadNoti(int receiverType, int uID) {
        ...
        try {
            ...
            System.out.println("NotificationDAO - getOther3NewestUnreadNoti: " + e.getMessage());
        }
        return list;
    }
    ...
    public int addNoti(NotificationDTO noti) {
        ...
        try {
            ...
            System.out.println("NotificationDAO - addNoti: " + e.getMessage());
        }
        return 0;
    }
    ...
    public void updateNotiStatus(int id, int isRead) {
        try {
            ...
            System.out.println("NotificationDAO - updateNotiStatus: " + e.getMessage());
        }
    }
}
